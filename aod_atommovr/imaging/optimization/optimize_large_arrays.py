...
def _generate_samples(
    ...
    for idx in range(n_samples):
        ...
        points, binary, row_spacing, col_spacing = sample_sparse_grid_points(
            grid_size=grid_size,
        ...
        rotated_points = rotate_points_about_center(
            jittered_points,
...
def _evaluate_params(
    ...
    for sample in samples:
        ...
        try:
            ...
            stats = compute_assignment_metrics(assigned, sample.binary)
            ...
            angle_diff = abs(angle_error_deg(est_angle, sample.angle_deg))
