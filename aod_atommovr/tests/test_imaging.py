    ...
    for grid_size in grid_sizes:
        for true_angle in angles:
            for seed in seeds:
                ...
                rotated = rotate_points_about_center(
                ...
                baseline_stats = compute_assignment_metrics(
                ...
                for method_name, estimator in methods.items():
                    ...
                    stats = compute_assignment_metrics(binary_pred, true_binary)
                    angle_error = angle_error_deg(est_angle, true_angle)
...
def test_final_extraction_pipeline(logger):
    ...
    assert np.array_equal(binary_centroids, true_binary), (
